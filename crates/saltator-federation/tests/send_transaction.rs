...
async fn send_transaction_routes_pdus_and_reports_results() {
    ...
    let state = Arc::new(FedState {
        ...
        rooms: Some(saltator_roomserver::RoomShards::single(rooms.clone())),
        users: None,
        client: None,
        edu_sink: None,
        media: None,
...
async fn send_fills_dag_gap_via_get_missing_events() {
    ...
    let a_state = Arc::new(FedState {
        ...
        rooms: Some(saltator_roomserver::RoomShards::single(rooms_a.clone())),
        users: None,
        client: None,
        edu_sink: None,
        media: None,
    ...
    let b_state = Arc::new(FedState {
        ...
        rooms: Some(saltator_roomserver::RoomShards::single(rooms_b.clone())),
        users: None,
